...
const ReasonsSection = () => {
  return (
    <div className='flex flex-col gap-3 w-full items-center mb-10'>
        <h3 className=' font-bold text-3xl mb-5 text-center'> REASONS TO CHOOSE ENJOY THE WOOD MAPS </h3>
        <div className=' flex w-full items-center justify-evenly flex-col md:flex-row my-8'>
